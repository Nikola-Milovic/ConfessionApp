# Confession App
An Android application to share and comment on others confessions. Comes together with a custom Nodejs server which can be found in [this github repository](https://github.com/Nikola-Milovic/Confession-Server).
...
Error screen and no confessions to fetch
--------------
